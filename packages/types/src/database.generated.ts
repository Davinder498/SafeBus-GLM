...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      record_notification_delivery_incident: {
        Args: { p_tenant_id: string | null; p_incident_code: string };
        Returns: number;
      };
      ...
      set_guardian_notification_preferences_v2: {
        Args: {
          ...
          p_email_pickup: boolean;
          p_email_dropoff: boolean;
          p_push_pickup_dropoff: boolean;
          p_push_trip_status: boolean;
      ...
      set_notification_preferences: {
        Args: {
          ...
          p_timezone_override: string | null;
          p_urgent_bypass_quiet_hours: boolean;
          p_preview_mode: string;
          p_categories: Json;
        };
        Returns: Json;
      };
