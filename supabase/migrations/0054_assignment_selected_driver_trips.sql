...
-- Student QR badge resolution was intentionally removed from the canonical
-- migration chain during Phase 0/1 reconciliation. The losing 0043 migration
-- that created student_qr_credentials is archived, so retaining this function
-- would make a clean rebuild fail and would keep a child-tracking surface
-- reachable. Bus QR tracking remains separate and canonical.
