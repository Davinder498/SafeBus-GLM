...
| `can_receive_notifications` | `student_guardians` | Consent flag for event notifications | Consent | Email provider (indirectly) | Per §4 |
...
| Notifications (outbox) | 90 days terminal state | Deletion job |
