...
| Stage | Target | Notes |
| --- | --- | --- |
| Stage A — Early commercial availability | Up to 250 buses | Small number of contracted Alberta tenants; high-touch; ≥60–90 operational-day observation. |
...
A successful Phase 11 pilot does **not** authorize a 20,000-bus launch.
