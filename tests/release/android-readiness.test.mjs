...
const requiredFiles = {
  ...
  'apps/web/src/pages/PrivacyPolicyPage.tsx': 'export const privacy = true;\n',
  'docs/governance/google-play-data-safety-notifications.md': '# Data safety\n',
  'docs/governance/google-play-publication.md': '# Play publication\n',
  'package.json': '{}\n',
  'playwright.android-store.config.ts': 'export default {};\n',
  'pnpm-lock.yaml': 'lockfileVersion: 9\n',
  'scripts/check-android-readiness.mjs': 'export const check = true;\n',
  'scripts/check-android-publication-preflight.mjs': 'export const preflight = true;\n',
  ...
  'tests/release/android-publication.test.mjs': 'export const publication = true;\n',
  'tests/release/android-readiness.test.mjs': 'export const readinessContract = true;\n',
  'tests/release-assets/android-store.spec.ts': 'export const screenshots = true;\n',
};
...
async function approvedFixture(root) {
  ...
  return {
    ...
    googlePlay: {
      storeListing: passed('PLAY/LISTING/001'),
      ...
      restrictedAppAccess: passed('PLAY/ACCESS/001'),
      publicPrivacyPolicy: passed('PLAY/PRIVACY/001'),
      publicAccountDeletion: passed('PLAY/DELETION/001'),
      bundleValidation: passed('PLAY/BUNDLE/001'),
      internalTesting: passed('PLAY/INTERNAL/001'),
      closedTesting: passed('PLAY/CLOSED/001'),
      preLaunchReport: passed('PLAY/PRE-LAUNCH/001'),
      productionEligibility: passed('PLAY/ELIGIBILITY/001'),
    },
    customerControls: {
