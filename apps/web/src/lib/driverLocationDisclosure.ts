...
export const DRIVER_LOCATION_DISCLOSURE =
  'BusSafe collects precise location data to show the active bus to authorized school staff and linked guardians even when the app is closed or not in use.';
