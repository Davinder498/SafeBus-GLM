...
const steps = [
  ...
  ['Routes', 'routes', '/admin/routes', 'Create transportation routes'],
  ['Stops', 'stops', '/admin/stops', 'Add ordered stops to routes'],
...
export function AdminSetupPage() {
  ...
  const complete = useMemo(() => snapshot ? steps.filter(([, key]) => snapshot[key] > 0).length : 0, [snapshot]);
